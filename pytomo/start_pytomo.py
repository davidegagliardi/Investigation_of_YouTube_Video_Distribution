...
def compute_stats(url, cache_uri, do_download_stats, redirect_url=None,
    ...
    #EDIT: The following line is used to export useful informations

    #config_pytomo.LOG.info('TEST %s %s %s %s %s %s %s', timestamp, url, ip_address, ping_times[0], download_stats[3], download_stats[13], download_stats[15])
